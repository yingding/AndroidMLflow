...
'''
Notice: 
only use the tf 2.11.0 legacy optimizer for pluggin architecture with
tensorflow metal and tensorflow macos, to force support of XLA path
https://developer.apple.com/forums/thread/721619

The legacy optimizers
